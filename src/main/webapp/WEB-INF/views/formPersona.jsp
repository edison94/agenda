	...
	<div class="container">
		...
		<form:form method="post" modelAttribute="persona"
			...
			<div class="form-group">
				...
				<form:input path="nombre" class="form-control" readonly="${readonly}" placeholder="Nombre" />
				<div class="has-error">
			...
			<div class="form-group">
				...
				<form:input path="apellido1" class="form-control" readonly="${readonly}" placeholder="Primer apellido"/>
				<div class="has-error">
			...
			<div class="form-group">
				...
				<form:input path="apellido2" class="form-control" readonly="${readonly}" placeholder="Segundo apellido"/>
				<div class="has-error">
			...
			<div class="form-group">
				...
				<form:input path="dni" class="form-control" readonly="${readonly}" placeholder="DNI"/>
				<div class="has-error">
			...
			<div class="form-group">
				...
				<form:input path="fechaNacimiento" class="form-control datepicker" readonly="${readonly}" placeholder="Fecha de nacimiento"/>
				<div class="has-error">
